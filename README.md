...
[![GitHub Stars](https://img.shields.io/github/stars/ishandutta2007/Awesome-Compensation-Management-Platform?style=flat-square&logo=github&color=gold)](https://github.com/ishandutta2007/Awesome-Compensation-Management-Platform/stargazers)
...
<a href="https://github.com/ishandutta2007/Awesome-Compensation-Management-Platform">
  <img src="assets/banner.svg" alt="Awesome Compensation Management Platform Banner" width="100%"/>
</a>
...
| **[Horilla HR](https://github.com/horilla/horilla-hr)** | [![GitHub stars](https://img.shields.io/github/stars/horilla/horilla-hr?style=social&color=white)](https://github.com/horilla/horilla-hr/stargazers) | Python / Django | Modern open-source HR and compensation framework with employee contract management, payroll processing, attendance tracking, and customizable bonus allowance rules. |
| **[Open Salaries](https://github.com/sizovs/open-salaries)** | [![GitHub stars](https://img.shields.io/github/stars/sizovs/open-salaries?style=social&color=white)](https://github.com/sizovs/open-salaries/stargazers) | Markdown / Docs | Curated collection of open-salary companies, transparent pay matrices, real-world case studies, and policy frameworks for building unbiassed pay scales. |
| **[CeleryBand](https://github.com/maybeanerd/celeryband)** | [![GitHub stars](https://img.shields.io/github/stars/maybeanerd/celeryband?style=social&color=white)](https://github.com/maybeanerd/celeryband/stargazers) | TypeScript / React / Node | Internal salary transparency platform enabling employees to anonymously input, visualize, and compare salary bands and percentile spreads within an organization. |
| **[Comparator](https://github.com/DevonPeroutky/comparator)** | [![GitHub stars](https://img.shields.io/github/stars/DevonPeroutky/comparator?style=social&color=white)](https://github.com/DevonPeroutky/comparator/stargazers) | JavaScript / HTML5 | Client-side tech offer evaluator and startup equity calculator modeling option grant dilution, valuation milestones, strike prices, and total rewards scenarios. |
| **[Comp Pulse](https://github.com/jschulman/comp-pulse)** | [![GitHub stars](https://img.shields.io/github/stars/jschulman/comp-pulse?style=social&color=white)](https://github.com/jschulman/comp-pulse/stargazers) | Python / Streamlit | Directional compensation tracker and analytics dashboard scraping public job postings and salary disclosure notices to visualize salary band drift. |
